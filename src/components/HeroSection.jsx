    ...
    <div id='hero' className='flex items-center justify-center flex-col py-20'>
       ...
       text-indigo-600 font-semibold dark:text-indigo-500'>
        ...
        <div className='space-x-4'>
            ...
            hover:bg-indigo-700 md:text-md'>get(projects)</a>
            ...
            <a href="https://drive.google.com/file/d/1PoOTV8Cdsz_00Ex2P7lxRY4xHhv1mPAi/view" className='inline-block px-8 py-3 border-transparent text-base 
            font-medium rounded-md text-white bg-indigo-600 
            hover:bg-indigo-700 md:text-md' target="_blank">
            <button className="outline-button-sm">get(resume)</button>
          </a>
          </div>
        </div>
   </div>
