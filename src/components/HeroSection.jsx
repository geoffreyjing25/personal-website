    ...
    <div id='hero' className='flex items-center justify-center flex-col py-20'>
       ...
       text-indigo-600 font-semibold dark:text-indigo-500'>
        ...
        <div className='space-x-8'>
            ...
            <a href="https://www.docdroid.net/VYckFeK/resume-pdf" target='blank' className='inline-block px-5 py-3 border-transparent text-base 
            font-medium rounded-md text-white bg-indigo-600 
            hover:bg-indigo-700 md:text-md'>seeResume()</a>
          </div>
        </div>
        {/* src/data/resume_geoffrey.pdf */}
   </div>
  )
}
