...
function About() {
  return (
    ...
    justify-center gap-10 md:gap-20 py-20'>
        ...
        <img src='https://i.im.ge/2024/08/12/fdSPVf.winning-photo-vertical.png'
...
// function About() {
//   return (
//     <div className='flex flex-col items-center justify-center gap-10 md:gap-20 py-20'>
//       <div className='flex flex-col md:flex-row items-center justify-center gap-10 md:gap-20'>
//         <div className='w-full md:w-6/12'>
//           <SectionTitle>About Me</SectionTitle>
//           <p className='text-md text-gray-600 dark:text-gray-300'>
//             👋 I'm Geoffrey Jing, a serial entrepreneur with experience in product, software, venture, & growth. I'm currently building @ 
//             <a href="https://albertjing.my.canva.site/tech-website-in-teal-white-navy-gradients-style" target="_blank" className='text-grey-700 dark:text-grey-300 text-orange-600 dark:text-orange-500'>
//               <b>Persimmon</b>
//             </a>, 
//             a two-sided mobile app and data marketplace focused on personal data monetization.
//           </p>
//           <p className='text-md text-gray-600 dark:text-gray-300'>
//             In the past, I developed a network architecture framework for LLM training + inference @ 
//             <a href="https://www.juniper.net/" target="_blank" className='text-grey-700 dark:text-grey-300 text-green-600 dark:text-green-600'>
//               <b>Juniper Networks</b>
//             </a>, 
//             built a GenAI internal portal with RAG from scratch @ 
//             <a href="https://benhamouglobalventures.com/" target="_blank" className='text-grey-700 dark:text-grey-300 text-blue-600 dark:text-blue-600'>
//               <b>BGV</b>
//             </a>, 
//             and created AI tools for internal customers at 
//             <a href="https://www.3m.com/" target="_blank" className='text-grey-700 dark:text-grey-300 text-red-500 dark:text-red-500'>
//               <b>3M</b>
//             </a>. 
//             Before that, I interned at 3 (pre-seed to seed stage) startups, wearing multiple hats and gaining insights into EdTech (B2B SaaS), Healthcare, and Supply Chain verticals.
//           </p>
//           <p className='text-md text-gray-600 dark:text-gray-300'>
//             I'm also a 
//             <a href="https://www.406ventures.com/files/406%20Ventures%20-%20Student%20Fellows%20Program%20Overview%20(2022).pdf" target="_blank" className='text-grey-700 dark:text-grey-300 text-green-800 dark:text-blue-300'>
//               <b>.406 Ventures Fellow</b>
//             </a>, 
//             part of a selective and prestigious fellowship made of the best student founders in the nation.
//           </p>
//           <p className='text-md text-gray-600 dark:text-gray-300'>
//             To connect with me, reach out by email below or book a meeting at the bottom right corner ↘️
//           </p>
//           <br />
//           <a href="mailto: jinggeoffrey@gmail.com" className="inline-block px-6 py-3 border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:text-md">
//             <button className="outline-button-sm">Contact Me 👈</button>
//           </a>
//         </div>

//         <div className='w-full md:w-6/12'>
//           <img src='https://i.im.ge/2024/08/12/fdSPVf.winning-photo-vertical.png' alt="Geoffrey Jing" className='w-full rounded-lg object-cover'/>
//         </div>
//       </div>

//       <div className='w-full md:w-8/12 mt-10'>
//       <SectionTitle>Some Fun Stats</SectionTitle>
//         <p className='text-l text-gray-600 dark:text-gray-300'>Fun Stats About Me:</p>
//         <p className='text-md text-gray-600 dark:text-gray-300'>Current age: <Age1 /></p>
//         <p className='text-md text-gray-600 dark:text-gray-300'>Fastest Typing Speed: 125 wpm</p>
//         <p className='text-md text-gray-600 dark:text-gray-300'>Number of sports I play: 12</p>
